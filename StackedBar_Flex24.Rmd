...
```{r}
# input <- list()
# input$stack_spatialunit <- "Network_Code"
# input$stack_userunit <- "CUPN"
# input$stack_season <- "Cycle"
# input$stack_year <- "2"
# input$stack_spatialhabitat <- "Group_A"
# input$stack_userhabitat <- "Appalachian & Interior Mesophytic Forest"
...
page_height = 550
  ...
  # species_group_og <- input$stack_usergroup
    ...
    plot_tree <- df_sptreefull %>%
       ...
       ggtitle("") + #ggtitle(paste0(input$stack_cycle, ": ", input$stack_year, ", ", input$stack_unit, ", ", input$stack_association)) ### change this to mean more information
