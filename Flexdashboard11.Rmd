...
genus_group <- load_data_by_keyword(folder_path, "grouping")
```
...
all_events <- df_events %>%
  ...
  left_join(location %>% dplyr::select(Network_Code, Park_Code, Subunit_Code, Plot_Code), by = "Plot_Code") #used to have Network Code
...
seedsap_plot <- seedsap_plot  %>%
  ...
  dplyr::mutate(Seedling_Density = sum(Seedling_Ht_5_50, 
                                       ...
                                       Seedling_Ht_15_30,
                                       Seedling_Ht_30_50,
                                       Seedling_Ht_50_137)/(Number_Sampled_Corners*0.0001), #for guln this should be /0.001 bc calculated at the 10 m2 level
